...
#define PLUGIN_NAME "inMemory"
#define PLUGIN_VERSION "2.0"

using namespace Plugin;

PluginDetails pluginInformation = {VMI_PLUGIN_API_VERSION, PLUGIN_NAME, PLUGIN_VERSION};
...
extern "C" bool init(PluginInterface* communicator, std::shared_ptr<IPluginConfig> config)
{
    auto success = true;
