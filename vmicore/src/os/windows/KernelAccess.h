#ifndef VMICORE_KERNELACCESS_H
#define VMICORE_KERNELACCESS_H
...
class IKernelAccess
{
  public:
    ...
    [[nodiscard]] virtual std::tuple<uint64_t, uint64_t> extractMmVadShortVpns(addr_t currentVadShortBaseVA) const = 0;
