...
namespace VmiCore
{
    ...
    class InterruptEventFixture : public testing::Test
    {
      protected:
        ...
        std::shared_ptr<testing::internal::MockFunction<InterruptEvent::InterruptResponse(InterruptEvent&)>>
            mockFunction =
        ...
        interruptCallbackFunction_t interruptCallback = InterruptEvent::createInterruptCallback(
            std::weak_ptr(mockFunction),
            &testing::MockFunction<InterruptEvent::InterruptResponse(InterruptEvent&)>::Call);
    ...
    TEST_F(InterruptEventCallbackFixture, createInterruptEvent_singleStepTriggered_togglesSingleStep)
    {
        ...
        EXPECT_CALL(*singleStepSupervisor, setSingleStepCallback(testVcpuId, _))
