...
namespace VmiCore
{
    ...
    class ReadProcessMemoryRegionFixture : public PluginSystemFixture
    {
      protected:
        ...
        memoryRegionTestInformation singlePageMemoryRegion{
        ...
        {
            threePagesMemoryRegion = createMultipageRegionInformation(
                threePagesRegionBaseVA, systemCR3, 3 * PagingDefinitions::pageSizeInBytes);
    ...
    TEST_F(ReadProcessMemoryRegionFixture,
           readProcessMemoryRegion_virtualAddressNotPageAligned_invalidArgumentException)
    {
