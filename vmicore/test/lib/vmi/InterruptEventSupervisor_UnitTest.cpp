...
namespace VmiCore
{
    ...
    namespace
    {
        ...
        constexpr uint64_t testSystemCr3 = 0xaaa00000;
        constexpr uint64_t testTracedProcessCr3 = 0xbbb00000;
        ...
        // TODO need processInformation here
        std::shared_ptr<ActiveProcessInformation> activeProcessInformation;
    }
    ...
    class InterruptEventFixture : public testing::Test
    {
      protected:
        ...
        std::shared_ptr<ActiveProcessInformation> systemProcessInformation =
            std::make_shared<ActiveProcessInformation>(ActiveProcessInformation{.processKernelDTB = testSystemCr3});
        ...
        void setupBreakpoint(addr_t eventVA,
                             ...
                             uint8_t memoryContent = 0xFE)
        {
            auto processDtb = eventVA >= PagingDefinitions::kernelspaceLowerBoundary
        ...
        void SetUp() override
        {
            activeProcessInformation = std::make_shared<ActiveProcessInformation>();
    ...
    {
        setupBreakpoint(testVA1, testPA1, activeProcessInformation, INT3_BREAKPOINT);

        EXPECT_THROW(interruptEventSupervisor->createBreakpoint(
                         testVA1, activeProcessInformation, breakpointCallbackFunction_t{}, true),
                     VmiException);
    }

    TEST_F(InterruptEventFixture, createBreakpoint_validParameters_doesNotThrow)
    {
        setupBreakpoint(testVA1, testPA1, activeProcessInformation);
        ...
        EXPECT_NO_THROW(interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), true));
    }

    TEST_F(InterruptEventFixture, createBreakpoint_newInt3OnNewPage_guardCreatedBeforeInt3Write)
    {
        testing::Sequence s1;
        activeProcessInformation->processUserDTB = testSystemCr3;
        setupBreakpoint(testVA1, testPA1, activeProcessInformation);
    ...
    {
        activeProcessInformation->processUserDTB = x86Regs.cr3;
        setupBreakpoint(testVA1, testPA1, activeProcessInformation);
        ...
        auto _occupant = interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, occupantMockFunction->AsStdFunction(), false);
        ...
        auto _conflictingInterrupt = interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, conflictingInterruptMockFunction->AsStdFunction(), false);
    ...
    TEST_F(InterruptEventFixture, teardown_twoDistinctEventsRegisteredOnSamePage_doesNotThrow)
    {
        ...
        auto breakpoint2 = interruptEventSupervisor->createBreakpoint(
            testVA1 + 1, activeProcessInformation, breakpointCallbackFunction_t{}, true);
    ...
    TEST_F(InterruptEventFixture, _defaultInterruptCallback_eventReadingR8_CorrectContent)
    {
        ...
        setupBreakpoint(testVA1, testPA1, activeProcessInformation);
        auto _event =
            interruptEventSupervisor->createBreakpoint(testVA1, activeProcessInformation, testCallbackReadsR8, true);
        auto* interruptEvent = setupInterruptEvent(testVA1, testPA1, x86Regs);
    ...
    {
        setupBreakpoint(testVA1, testPA1, activeProcessInformation, testOriginalMemoryContent);
    ...
    {
        setupBreakpoint(testVA1, testPA1, activeProcessInformation, testOriginalMemoryContent);
        setupBreakpoint(testVA2, testPA2, activeProcessInformation, testOriginalMemoryContent2);
        auto _breakpoint1 = interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), true);
        auto _breakpoint2 = interruptEventSupervisor->createBreakpoint(
            testVA2, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), true);
        EXPECT_CALL(*vmiInterface, write8PA(_, _)).Times(AnyNumber());
    ...
    {
        setupBreakpoint(testVA1, testPA1, activeProcessInformation);
        setupBreakpoint(testVA2, testPA2, activeProcessInformation);
        auto _breakpoint1 = interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), true);
        auto _breakpoint2 = interruptEventSupervisor->createBreakpoint(
            testVA2, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), true);
    ...
    {
        activeProcessInformation->processUserDTB = testTracedProcessCr3;
        activeProcessInformation->processKernelDTB = testSystemCr3;
        setupBreakpoint(testVA1, testPA1, activeProcessInformation);
        auto breakpoint1 = interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), false);
           ...
           _defaultContextSwitchCallback_oneGlobalOneProcessExclusiveBpInSystemContextSwitch_processExclusiveBpDisabled)
    {
        ...
        auto breakpoint1 = interruptEventSupervisor->createBreakpoint(
            testVA1, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), true);
        auto breakpoint2 = interruptEventSupervisor->createBreakpoint(
            testVA2, activeProcessInformation, mockBreakpointCallback->AsStdFunction(), false);
        interruptSupervisorInternalEvent->reg_event.value = testSystemCr3;
        EXPECT_CALL(*vmiInterface, write8PA(testPA1, testOriginalMemoryContent)).Times(0);
